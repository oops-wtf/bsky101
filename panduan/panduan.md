...
0. Selalu gunakan [App Passwords]({% link pengaturan/password.md %}) setiap menggunakan aplikasi klien dari pihak ketiga. Berbeda dengan kata sandi saat pertama kali mendaftar, kata sandi ini bersifat **sementara** dan **bisa dihapus** atau dibuat ulang untuk keperluan berbagai macam aplikasi.
